...
const ProductCarouselPrevious = React.forwardRef<
    HTMLButtonElement,
    React.ComponentProps<typeof ProductButton>
>(
    ({ className, variant = "outline", size = "icon", ...props }, ref) => {
        ...
        return (
            <ProductButton
                ...
                size={size}
                className={cn(
                    "absolute h-8 w-8 rounded-full border-border/50 bg-background/80 backdrop-blur-sm transition-all hover:bg-accent hover:text-accent-foreground",
...
export {
    ProductCarousel as Carousel,
    ProductCarouselContent as CarouselContent,
    ProductCarouselItem as CarouselItem,
    ProductCarouselPrevious as CarouselPrevious,
    ProductCarouselNext as CarouselNext,
};
