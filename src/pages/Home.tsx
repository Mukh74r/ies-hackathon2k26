        ...
        <div className="min-h-screen bg-[#0F1B2A] text-[#F2F3F3] font-sans-academic selection:bg-[#FF9900]/30">
            ...
            <section className="pt-16 pb-16 px-6 sm:px-12 max-w-7xl mx-auto">
                <div className="max-w-4xl">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-[#1A2433] border border-[#2E3B4E] text-xs font-mono-stamp text-[#FF9900] mb-6 shadow-sm">
                        <GraduationCap size={14} className="text-[#FF9900]" />
                        <span>FACULTY WORKBENCH · CBSE & STATE BOARDS ALIGNED</span>
                    </div>

                    <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold font-display tracking-tight text-[#FFFFFF] leading-[1.15] mb-6">
                        The Curriculum & Examination Architecture Platform for Indian Faculty
                    </h1>

                    <p className="text-base sm:text-lg text-[#AAB7B8] leading-relaxed max-w-3xl mb-8 font-sans-academic">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-10">
                        <button
                            ...
                            className="px-6 py-3 rounded-md bg-[#FF9900] hover:bg-[#EC7211] text-[#0F1B2A] font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-colors shadow-md"
                        >
                        ...
                        <a
                            ...
                            className="px-5 py-3 rounded-md bg-[#1A2433] border border-[#2E3B4E] hover:border-[#00A4E4] text-[#F2F3F3] text-xs font-semibold uppercase tracking-wider flex items-center justify-center gap-2 transition-colors"
                        >
                        ...
                        <button
                            ...
                            className="px-5 py-3 rounded-md bg-[#1A2433] border border-[#2E3B4E] hover:border-[#FF9900] text-[#AAB7B8] hover:text-[#FFFFFF] text-xs font-semibold uppercase tracking-wider flex items-center justify-center gap-2 transition-colors"
                        >
                    ...
                    {/* Board Badges */}
                    <div className="pt-6 border-t border-[#2E3B4E] flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-[#AAB7B8]">
                        <span className="font-mono-stamp text-[#FF9900] uppercase font-bold">Curriculum Blueprints:</span>
            ...
            <section id="blueprint-workbench" className="py-12 px-6 sm:px-12 max-w-7xl mx-auto">
                <div className="mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                    <div>
                        <div className="text-xs font-mono-stamp text-[#FF9900] uppercase tracking-wider mb-1 font-bold">
                            Interactive Studio Preview
                        </div>
                        <h2 className="text-2xl font-bold font-display text-[#FFFFFF]">
                            Curriculum & Question Workbench
                        </h2>
                    </div>
                    {/* Mode Selector */}
                    <div className="flex bg-[#1A2433] border border-[#2E3B4E] rounded-md p-1">
                        {[
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 rounded text-xs font-semibold transition-colors ${
                                    activeTab === tab.id
                                        ? 'bg-[#FF9900] text-[#0F1B2A] font-bold shadow-sm'
                                        : 'text-[#AAB7B8] hover:text-[#FFFFFF]'
                                }`}
                            >
                                {tab.label}
                            </button>
                ...
                {/* Workbench Frame */}
                <div className="bg-[#1A2433] border border-[#2E3B4E] rounded-lg overflow-hidden shadow-2xl">
                    {/* Controls Bar */}
                    <div className="bg-[#0B121E] border-b border-[#2E3B4E] p-4 flex flex-wrap items-center justify-between gap-4">
                        <div className="flex flex-wrap items-center gap-3 text-xs">
                            <div className="flex items-center gap-1.5">
                                <span className="font-mono-stamp text-[#AAB7B8]">BOARD:</span>
                                <select
                                    value={selectedBoard}
                                    onChange={(e) => setSelectedBoard(e.target.value)}
                                    className="bg-[#0F1B2A] border border-[#2E3B4E] rounded px-2.5 py-1 text-[#FFFFFF] text-xs font-semibold focus:outline-none focus:border-[#FF9900]"
                                >
                            ...
                            <div className="flex items-center gap-1.5">
                                <span className="font-mono-stamp text-[#AAB7B8]">CLASS:</span>
                                <select
                                    value={selectedGrade}
                            ...
                            <div className="flex items-center gap-1.5">
                                <span className="font-mono-stamp text-[#AAB7B8]">SUBJECT:</span>
                                <select
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                onClick={() => navigate('/turbo')}
                                className="px-3 py-1 rounded bg-[#FF9900]/10 border border-[#FF9900]/40 hover:bg-[#FF9900]/20 text-[#FF9900] text-xs font-bold font-mono-stamp uppercase flex items-center gap-1.5 transition-colors"
                            >
                                <Printer size={13} />
                    ...
                    <div className="p-6 sm:p-8 bg-[#0B121E]">
                        <div className="max-w-4xl mx-auto bg-[#1A2433] border border-[#2E3B4E] rounded-md p-6 sm:p-10 shadow-2xl">
                            {/* Academic Paper Header */}
                            <div className="text-center pb-6 mb-6 border-b border-[#2E3B4E] space-y-1">
                                <div className="text-xs font-mono-stamp text-[#AAB7B8] uppercase">
                                    ACADEMIC YEAR 2026-2027 · FORMATIVE ASSESSMENT
                                </div>
                                <h3 className="text-lg sm:text-xl font-bold font-display text-[#FFFFFF] tracking-tight">
                                    {boardBlueprints[activeTab].title}
                                </h3>
                                <div className="flex justify-between items-center text-xs font-mono-stamp text-[#AAB7B8] pt-2 max-w-md mx-auto">
                            ...
                            <div className="space-y-6">
                                {boardBlueprints[activeTab].sections.map((sec, sIdx) => (
                                    <div key={sIdx} className="space-y-3">
                                        <div className="text-xs font-bold font-mono-stamp text-[#FF9900] uppercase tracking-wider border-b border-[#2E3B4E] pb-1">
                                            {sec.heading}
                                        </div>
                                            ...
                                            {sec.questions.map((q, qIdx) => (
                                                <div key={qIdx} className="space-y-1.5 text-xs sm:text-sm">
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <span className="text-[#F2F3F3] font-sans-academic leading-relaxed">{q.text}</span>
                                                    </div>
                                                    {q.options.length > 0 && (
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 pl-6 pt-1 text-xs text-[#AAB7B8]">
                                                    ...
                                                    {q.correct && (
                                                        <div className="mt-1 ml-6 p-2 rounded bg-[#0F1B2A] border border-[#2E3B4E] text-[11px] font-mono-stamp text-[#00A4E4]">
                                                            {q.correct}
                                                        </div>
                                                    )}
                                                </div>
                            ...
                            {/* Bottom Footer Note */}
                            <div className="mt-8 pt-4 border-t border-[#2E3B4E] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#AAB7B8]">
            ...
            <section className="py-16 px-6 sm:px-12 max-w-7xl mx-auto border-t border-[#2E3B4E]">
                <div className="max-w-2xl mb-12">
                    <span className="text-xs font-mono-stamp text-[#FF9900] uppercase tracking-wider font-bold">Functional Architecture</span>
                    <h2 className="text-2xl sm:text-3xl font-bold font-display text-[#FFFFFF] mt-1">
                    ...
                    {[
                        ...
                        return (
                            <div
                                key={idx}
                                onClick={() => navigate('/turbo')}
                                className="bg-[#1A2433] border border-[#2E3B4E] hover:border-[#FF9900]/60 p-6 sm:p-8 rounded-lg transition-colors cursor-pointer group flex flex-col justify-between shadow-lg"
                            >
                                <div>
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="p-2.5 rounded bg-[#0F1B2A] border border-[#2E3B4E] text-[#FF9900]">
                                            <Icon size={20} />
                                        </div>
                                    ...
                                    <h3 className="text-lg font-bold font-display text-[#FFFFFF] group-hover:text-[#FF9900] transition-colors mb-2">
                                        {card.title}
                                    </h3>
                                    <p className="text-xs sm:text-sm text-[#AAB7B8] leading-relaxed">
                                        {card.desc}
                                    </p>
                                </div>
                                <div className="mt-6 pt-4 border-t border-[#2E3B4E] flex items-center justify-between text-xs font-mono-stamp text-[#FF9900]">
            ...
            <section className="py-16 px-6 sm:px-12 max-w-7xl mx-auto border-t border-[#2E3B4E]">
                <div className="max-w-2xl mb-8">
                    <span className="text-xs font-mono-stamp text-[#FF9900] uppercase tracking-wider font-bold">Regional Accessibility</span>
                    <h2 className="text-2xl sm:text-3xl font-bold font-display text-[#FFFFFF] mt-1">
                        Native Synthesis in 11 Indian Languages
                    </h2>
                    <p className="text-xs sm:text-sm text-[#AAB7B8] mt-2">
            ...
            {/* ── 5. Footer ── */}
            <footer className="border-t border-[#2E3B4E] bg-[#0B121E] py-8 px-6 sm:px-12 text-xs text-[#AAB7B8]">
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-2">
                        <span className="font-bold font-display text-[#FFFFFF]">DeepHub AI</span>
                        <span>· Curriculum & Examination Architecture</span>
                    </div>
                    <div className="flex items-center gap-6">
                        <span onClick={() => navigate('/terms')} className="hover:text-[#FFFFFF] cursor-pointer">Terms & Conditions</span>
                        <span onClick={() => navigate('/privacy')} className="hover:text-[#FFFFFF] cursor-pointer">Privacy Policy</span>
                        <span onClick={() => navigate('/pricing')} className="hover:text-[#FFFFFF] cursor-pointer">Institutional Pricing</span>
